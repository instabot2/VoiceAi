...
const Home = () => {
  return (
    <>
        <Navbar1 logo="https://i.postimg.cc/vBd2MN55/5cb480cd5f1b6d3fbadece79.png" name="VoiceAi" button5="Get Started"/>
